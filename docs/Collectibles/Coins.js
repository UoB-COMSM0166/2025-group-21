class Coins {
    ...
    // Called to add coins to the map
    update(offset) {
        // Delete old missed coins
        ...
        while (this.lastX < offset + width + 500) {
            ...
            // Get coin position and float it above the terrain
    ...
    // Calculate the coins position with equidistant spacing from prior coin
    calculateCoords(startX) {
        ...
        let currentX = 0;
        let currentY = 0;
        // Iterate through the coins and calc position
    ...
    // Check for player collision with the coins
    checkCollision() {
        for (let i = this.coins.length - 1; i >= 0; i--) {
            ...
            if (d < 30) {
                // Save and remove from coins array
    ...
    // Animation for the coin collection
...
if (typeof module !== 'undefined') { module.exports = Coins; }